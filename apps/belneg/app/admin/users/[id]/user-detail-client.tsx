...
export default function UserDetailClient({ initialUser, units }: { initialUser: User; units: Unit[] }) {
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6 lg:p-8">
      {/* Breadcrumb */}
      <Link href="/admin/users" className="inline-flex items-center gap-1 text-[12px] text-ink-muted hover:text-accent-glow">
        <ChevronLeft size={14}/> Kembali ke daftar user
      </Link>
